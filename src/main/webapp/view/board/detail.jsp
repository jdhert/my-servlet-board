        ...
        <div class="card mb-4 w-50 mx-auto">
            ...
            <div class="d-flex flex-column" style="height: 500px;">
                ...
                <div class="d-flex flex-row-reverse mb-3 mr-3">
                    &nbsp
                    &nbsp
                    <a href="/board/delete?id=${board.getId()}" class="btn btn-secondary btn-sm" onclick="return confirm('삭제하시겠습니까?')" ${param.author == board.getWriter() ? "" : "hidden"}><small>삭제하기</small></a>
                    &nbsp
                    <a href="/board/updateForm?id=${board.getId()}&id2=${param.id2}&ide=${param.ide}&author=${param.author}" class="btn btn-secondary btn-sm" ${param.author == board.getWriter() ? "" : "hidden"}><small>수정하기</small></a>
                    &nbsp
